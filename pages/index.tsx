            ...
            >
              <div className={styles.aboutContainer2}>
                <div className={styles.aboutText}>
                  ...
                  <Paragraph size="medium">
                    Somos una empresa mexicana que busca impactar positivamente
                    en el sector de la industria inmobiliaria creando productos
                    que otorgen inmediatez en la liquidez de los propietarios de
                  ...
                  <Paragraph size="medium">
                    <b>
                      Nuestra Misión es ofrecer soluciones de liquidez inmediata
                      a los propietarios de bienes inmuebles. Si tienes una
                  ...
                  <article className={styles.reviewsSliderItem}>
                    ...
                    <div className={styles.reviewsSliderItemText}>
                      ...
                      <Paragraph size="medium">
                        ...
                        elit. Sed id risus euismod, aliquam ipsum in, tempor
                        elit. Sed id risus euismod, aliquam ipsum in.
                      </Paragraph>
